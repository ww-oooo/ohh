    ...
    $.Gallery.prototype = {
        ...
        _layout: function () {
            ...
            if (this.support3d && this.supportTrans) {
                leftCSS = {
                    '-webkit-transform': 'translateX(-635px) translateZ(-388px) rotateY(-35deg)',
                    '-moz-transform': 'translateX(-635px) translateZ(-388px) rotateY(-35deg)',
                    '-o-transform': 'translateX(-635px) translateZ(-388px) rotateY(-35deg)',
                    '-ms-transform': 'translateX(-635px) translateZ(-388px) rotateY(-35deg)',
                    'transform': 'translateX(-635px) translateZ(-388px) rotateY(-35deg)'
                };
                rightCSS = {
                    '-webkit-transform': 'translateX(635px) translateZ(-388px) rotateY(35deg)',
                    '-moz-transform': 'translateX(635px) translateZ(-388px) rotateY(35deg)',
                ...
                leftCSS = {
                    '-webkit-transform': 'translate(-635px) scale(0.6)',
                    '-moz-transform': 'translate(-635px) scale(0.6)',
                    '-o-transform': 'translate(-635px) scale(0.6)',
                    '-ms-transform': 'translate(-635px) scale(0.6)',
                    'transform': 'translate(-635px) scale(1.2)'
                };
                rightCSS = {
                    '-webkit-transform': 'translate(635px) scale(0.6)',
                    '-moz-transform': 'translate(635px) scale(0.6)',
                    '-o-transform': 'translate(635px) scale(0.6)',
                    '-ms-transform': 'translate(635px) scale(0.6)',
                    'transform': 'translate(635px) scale(0.6)'
                };
                currentCSS = {
                    'z-index': 999
                };
        ...
        _getCoordinates: function (position) {
            if (this.support3d && this.supportTrans) {
                ...
                switch (position) {
                    ...
                    case 'left':
                        return {
                            '-webkit-transform': 'translate(-650px) scale(0.6)',
                            '-moz-transform': 'translate(-650px) scale(0.6)',
                            '-o-transform': 'translate(-650px) scale(0.6)',
                            '-ms-transform': 'translate(-650px) scale(0.6)',
                            'transform': 'translate(-650px) scale(0.6)',
                            'opacity': 1,
                            'visibility': 'visible'
                        };
                        break;
